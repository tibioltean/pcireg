...
CREATE TABLE IF NOT EXISTS `intervention` (
  ...
  `rpda` int(3) NOT NULL COMMENT 'Right posterior descending artery (rPDA)',
  `posteo_segment` int(3) NOT NULL COMMENT 'Right posterolateral segment and branch',
  `lm_artery` int(3) NOT NULL COMMENT 'Left main artery (LM)',
  `plad` int(3) NOT NULL COMMENT 'Proximal LAD artery (pLAD)',
  `mlad` int(3) NOT NULL COMMENT 'Mid-LAD artery (mLAD)',
  `dlad` int(3) NOT NULL COMMENT 'Distal LAD artery (dLAD)',
  `1_diagonal` int(3) NOT NULL COMMENT 'First diagonal branch (1st Diag)',
  `2_diagonal` int(3) NOT NULL COMMENT 'Second diagonal branch (2nd Diag)',
  `pcirc` int(3) NOT NULL COMMENT 'Proximal circumflex coronary (pCIRC)',
  `intart` int(3) NOT NULL,
  `om` int(3) NOT NULL COMMENT 'First obtuse marginal branch (1st OM)',
  `som` int(3) NOT NULL,
  `circ` int(3) NOT NULL COMMENT 'Mid Circumflex artery (CIRC)',
  `obtuse_segments` int(3) NOT NULL COMMENT 'Other obtuse segments',
  `lpda` int(3) NOT NULL,
